...
const BuildAppsIcon = ({ isSelected }: { isSelected: boolean }) => (
  ...
  >
    <path
      ...
      stroke={isSelected ? "#155EEF" : "#667085"}
      strokeWidth="1.25"
      strokeLinecap="round"
      ...
      >
        <div className="flex items-center">
          <div className="relative flex shrink-0 grow-0 cursor-pointer items-center gap-2">
            <img
              ...
              alt="logo"
            />
            <p className="shrink-0 grow-0 text-left text-xl font-medium text-black">
              DecentralAI
            </p>
          </div>
        </div>
        <div className="flex items-center">
          ...
          <Nav
            icon={
              <BuildAppsIcon
                isSelected={["apps", "app"].includes(selectedSegment || "")}
              />
            }
            ...
            curNav={
              curApp && {
                ...
                name: curApp.name,
                icon: curApp.icon,
                icon_background: curApp.icon_background,
              }
            }
          ...
          <Nav
            ...
            curNav={
              currentDataset && {
                ...
                icon: currentDataset.icon,
                icon_background: currentDataset.icon_background,
              }
            }
