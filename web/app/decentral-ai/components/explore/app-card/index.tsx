      ...
      <div className="col-span-1 bg-white border-2 border-solid border-transparent rounded-lg shadow-sm min-h-[160px] flex flex-col transition-all duration-200 ease-in-out hover:shadow-lg">
        <div className="flex pt-[14px] px-[14px] pb-3 h-[66px] items-center gap-3 grow-0 shrink-0">
          ...
          <div className="relative h-8 text-sm font-medium leading-8 grow">
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden text-ellipsis whitespace-nowrap">
              {appBasicInfo.name}
            </div>
          </div>
        </div>
