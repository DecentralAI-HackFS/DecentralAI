...
export const fetchAppList: Fetcher<
  AppListResponse,
...
export const fetchAppDetail: Fetcher<
  AppDetailResponse,
...
export const fetchAppTemplates: Fetcher<
  AppTemplatesResponse,
  { url: string }
> = ({ url }) => {
...
export const createApp: Fetcher<
  AppDetailResponse,
  {
    name: string;
    icon: string;
...
> = ({ name, icon, icon_background, mode, config }) => {
  return post("apps", {
    body: { name, icon, icon_background, mode, model_config: config },
  }) as Promise<AppDetailResponse>;
};
...
export const updateAppName: Fetcher<
  UpdateAppNameResponse,
...
export const updateAppSiteStatus: Fetcher<
  AppDetailResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
export const updateAppApiStatus: Fetcher<
  AppDetailResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
  return post(url, { body }) as Promise<AppDetailResponse>;
...
export const updateAppRateLimit: Fetcher<
  AppDetailResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
  return post(url, { body }) as Promise<AppDetailResponse>;
...
export const updateAppSiteAccessToken: Fetcher<
  UpdateAppSiteCodeResponse,
  { url: string }
> = ({ url }) => {
...
export const updateAppSiteConfig: Fetcher<
  AppDetailResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
  return post(url, { body }) as Promise<AppDetailResponse>;
...
export const getAppDailyConversations: Fetcher<
  AppDailyConversationsResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const getAppDailyEndUsers: Fetcher<
  AppDailyEndUsersResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const getAppTokenCosts: Fetcher<
  AppTokenCostsResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const updateAppModelConfig: Fetcher<
  UpdateAppModelConfigResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
// For temp testing
export const fetchAppListNoMock: Fetcher<
  AppListResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
  return get(url, params) as Promise<AppListResponse>;
...
export const fetchApiKeysList: Fetcher<
  ApikeysListResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const delApikey: Fetcher<
  CommonResponse,
  { url: string; params: Record<string, any> }
> = ({ url, params }) => {
...
export const createApikey: Fetcher<
  CreateApiKeyResponse,
  { url: string; body: Record<string, any> }
> = ({ url, body }) => {
...
export const validateOpenAIKey: Fetcher<
  ValidateOpenAIKeyResponse,
...
export const updateOpenAIKey: Fetcher<
  UpdateOpenAIKeyResponse,
  { url: string; body: { token: string } }
> = ({ url, body }) => {
...
export const generationIntroduction: Fetcher<
  GenerationIntroductionResponse,
  { url: string; body: { prompt_template: string } }
> = ({ url, body }) => {
